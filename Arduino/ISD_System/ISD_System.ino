//  This code contains a combined control system for a hub motor and a stepper motor using an Arduino.
//  It utilizes the Adafruit MCP4725 DAC for voltage control of the hub motor and the AccelStepper library for precise stepper motor movements.
//  The system listens for serial commands to control both motors, allowing for direction and speed adjustments.
