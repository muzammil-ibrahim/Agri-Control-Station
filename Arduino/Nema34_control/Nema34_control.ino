// Nema34 Stepper Motor Control with Arduino
// This code controls a Nema34 stepper motor using an Arduino.
//  The better version uses the AccelStepper library for smoother motion and acceleration control, while the simpler version uses direct pin manipulation for step pulses.
