//  This code is for controlling a DDSM115 motor in position mode using an Arduino.
//  It demonstrates how to send commands to the motor to move to specific positions (in degrees) and includes functions for changing the motor mode, sending control packets, and querying the motor's current mode. 
