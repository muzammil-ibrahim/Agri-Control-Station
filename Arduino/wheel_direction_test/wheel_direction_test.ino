//  This code is designed to test the direction control of a motor using a relay and PWM signal. 
//  It alternates between forward and reverse directions, maintaining a constant speed for a specified duration.
//  uses relay switching to change direction of the 1000 watt hub motor 
