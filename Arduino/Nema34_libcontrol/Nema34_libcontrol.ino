//  Uses library AccelStepper to control a Nema34 stepper motor with a driver.
//  better than using digitalWrite() and delayMicroseconds() for step pulses, as it allows for acceleration and deceleration control.
