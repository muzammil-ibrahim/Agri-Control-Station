// This is the test code for the AS5600 magnetic rotary encoder using an Arduino.
// It reads the raw angle from the encoder and converts it to degrees, printing the results to the serial monitor.
