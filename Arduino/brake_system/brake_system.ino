//  this code is for the prototype of a brake system using an Arduino UNO. 
// It uses two servo motors to simulate the braking mechanism. 
// The servos can be controlled to move forward or backward based on the received commands. 
// The system limits the servo movement to ±20° from their initial positions to ensure safe operation.
